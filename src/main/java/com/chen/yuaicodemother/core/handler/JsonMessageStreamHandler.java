...
import com.chen.yuaicodemother.ai.model.message.*;
...
public class JsonMessageStreamHandler {
    ...
    public JsonMessageStreamHandler(ToolManager toolManager, VueProjectBuilder vueProjectBuilder) {
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    //异步构建Vue项目
                    String projectPath = AppConstant.getCodeOutputRootDir() + "/vue_project_" + appId;
    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        try {
            ...
            log.error("解析 JSON 消息失败: {}, 原始 chunk: {}", e.getMessage(), chunk, e);
            return "";
        }
    }
